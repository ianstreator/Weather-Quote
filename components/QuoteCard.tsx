...
function QuoteCard({ quote }: ServerSideAssets) {
  return (
    <div className="w-screen max-h-72 text-white py-4 flex flex-row justify-center bg-gradient-to-b from-zinc-900 md:w-max md:ml-6 md:h-fit md:bg-gradient-to-tl md:from-zinc-800/50 md:to-zinc-800 ">
