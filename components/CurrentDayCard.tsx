...
function CurrentDayCard({ weather, city }: CityWeatherData) {
  ...
  return (
    <div className="card max-w-xs w-10/12 max-h-80 rounded-none bg-black/50 backdrop-blur-sm text-center  text-white mx-auto p-2 flex flex-row content-center md:mx-0 md:max-w-lg">
